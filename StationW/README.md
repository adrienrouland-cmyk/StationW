...
```bash
# Start the FastAPI server (recommended: use a virtual environment)
# If you get "externally-managed-environment" or build errors for pydantic-core,
# create and use a local venv with a supported Python version before installing.
cd /home/mqht/Documents/FINAL/StationW
python3 -m venv .venv
...
# Alternative: if you have the `uv` Python manager and need Python 3.12
